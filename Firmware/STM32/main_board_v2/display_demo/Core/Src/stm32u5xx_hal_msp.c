...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PB1     ------> LPUART1_RTS
    */
    HAL_GPIO_DeInit(GPIOG, GPIO_PIN_7|GPIO_PIN_8|GPIO_PIN_5);
...
void HAL_OSPI_MspDeInit(OSPI_HandleTypeDef* hospi)
{
  ...
  /* USER CODE END OCTOSPI1_MspDeInit 0 */
    ...
    PE11     ------> OCTOSPIM_P1_NCS
    */
    HAL_GPIO_DeInit(GPIOH, GPIO_PIN_8|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_9
                          |GPIO_PIN_12);
    ...
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_12|GPIO_PIN_10);
